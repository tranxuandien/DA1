...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \FosBundle\Form\ProfileType A FosBundle\Form\ProfileType instance.
     */
    protected function getApp_Form_ProfileService()
    {
        return $this->services['app.form.profile'] = new \FosBundle\Form\ProfileType();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \FosBundle\Form\RegistrationType A FosBundle\Form\RegistrationType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \FosBundle\Form\RegistrationType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'demo', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\UserBundle\\Resources\\config\\doctrine') => 'UserBundle\\Entity', ($this->targetDirs[3].'\\src\\FosBundle\\Resources\\config\\doctrine') => 'FosBundle\\Entity'));
        ...
        $b->addDriver($a, 'FosBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'FosBundle' => 'FosBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e9f841a5ff840ff807f7badb385e1b2d32032498ed6b7d470c7baece6a2a3f11');
    ...
    {
        return $this->services['easyadmin.autocomplete'] = new \JavierEguiluz\Bundle\EasyAdminBundle\Search\Autocomplete($this->get('easyadmin.config.manager'), new \JavierEguiluz\Bundle\EasyAdminBundle\Search\Finder($this->get('easyadmin.query_builder')), $this->get('property_accessor'));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('FosBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('noreply@gmail.com' => 'DATN'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'FosBundle\\Form\\ProfileType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('FosBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'FosBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('FosBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('FosBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'FosBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener($this->get('request_stack'), 'vi', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'FosBundle\\Model\\UserInterface' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13)), 'FOS\\UserBundle\\Model\\UserInterface' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n->setOptions(array('default_target_path' => '/home', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('trangia93vnbk@gmail.com');
        $a->setPassword('gmailTg9339gT');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\FosBundle/Resources/views'), 'Fos');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5b0ca9f5b27a5a37663a1dc9e84b9d316a95e685');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'trangia93vnbk@gmail.com',
            'mailer_password' => 'gmailTg9339gT',
            'secret' => '5b0ca9f5b27a5a37663a1dc9e84b9d316a95e685',
            'mailer_host' => 'smtp.gmail.com',
            'locale' => 'vi',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '5b0ca9f5b27a5a37663a1dc9e84b9d316a95e685',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'trangia93vnbk@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'gmailTg9339gT',
            ...
            'fos_user.model.user.class' => 'FosBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'FosBundle\\Form\\ProfileType',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'noreply@gmail.com' => 'DATN',
            ),
            'fos_user.registration.confirmation.enabled' => true,
            'fos_user.registration.form.type' => 'FosBundle\\Form\\RegistrationType',
            ...
            'easyadmin.config' => array(
                'entities' => array(
                    'Brand' => array(
                        'label' => 'Thương hiệu',
                        'class' => 'UserBundle\\Entity\\Brands',
                        'name' => 'Brand',
                    ),
                    'Salon' => array(
                        'label' => 'Salon Ô TÔ',
                        'class' => 'UserBundle\\Entity\\ShopInfo',
                        'name' => 'Salon',
                    ),
                    'BuyNews' => array(
                        'label' => 'Tin Mua',
                        'class' => 'UserBundle\\Entity\\BuyNews',
                    ...
                    'SellNews' => array(
                        'label' => 'Tin Bán',
                        'class' => 'UserBundle\\Entity\\SellNews',
                        'disabled_actions' => array(
                            0 => 'edit',
                            1 => 'new',
                        ),
